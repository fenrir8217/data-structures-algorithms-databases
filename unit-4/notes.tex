...
\begin{figure}[htp]
  \centering
  \includegraphics[width=15cm]{unit-4/figures/02.png}
\end{figure}
...
A Spanning Tree is a subgraph of a given connected, undirected graph that includes all vertices and is itself a tree (which means no cycles).

Minimum Spanning Tree (MST) is a spanning tree with the minimum total edge weight.
\begin{figure}[htp]
  \centering
  \includegraphics[width=15cm]{unit-4/figures/01.png}
\end{figure}
...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=15cm]{unit-4/figures/MST_Example.png}
