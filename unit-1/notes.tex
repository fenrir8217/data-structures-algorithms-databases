...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=15cm]{unit-1/figures/bubble_sort.png}
...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=15cm]{unit-1/figures/merge_sort.png}
 \caption*{The structure of a packet frame.}
\end{figure}

\begin{figure}[!htbp]
 \centering
 \includegraphics[width=15cm]{unit-1/figures/stable_unstable.png}
 \caption*{The structure of a packet frame.}
\end{figure}


\textbf{Python Implementation:}
	See the code on Canvas.
