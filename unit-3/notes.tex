...
\begin{center}
  \begin{figure}[!htbp]
    \centering
    \includegraphics[width=15cm]{unit-3/figures/balance.png}
...
The number of nodes grows \textbf{exponentially} as a function of the height. \\
The height grows \textbf{logarithmically} as a function of the number of nodes. \\
...
\begin{figure}[!htbp]
 \centering
 \includegraphics[width=15cm]{unit-3/figures/rotate_4_cases.png}
 \caption*{4 cases}
\end{figure}
\end{center}
\textcolor{red}{Start with the lowest node with an imbalance!}
