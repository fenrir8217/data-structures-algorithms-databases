...
\usepackage{longtable} % Intermix single and multiple columns
...
\section{DSAD-Practices}
\input{unit-11/notes-1.tex}
\input{unit-11/notes-2.tex}
\input{unit-11/notes-3.tex}
\input{unit-11/notes-10.tex}
\input{unit-11/notes-11.tex}

\input{unit-11/class-tests.tex}


\input{unit-11/unassessed-1.tex}
\input{unit-11/unassessed-2.tex}
\input{unit-11/unassessed-3.tex}
\pagebreak
\input{unit-11/past-paper.tex}

\input{unit-11/avl-code.tex}

\pagebreak
\section{AIML Exercises}{AIML Practices}
\input{aiml_exercises/mock.tex}
\pagebreak
\input{aiml_exercises/past-24.tex}
\input{aiml_exercises/exercise-10.tex}
\end{document}
